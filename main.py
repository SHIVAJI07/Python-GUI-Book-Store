...
b1=Button(window,text="ViewAll",width=15,command=view_command)
b1.grid(row=4,column=3)

b2=Button(window,text="SearchEntry",width=15,command=search_command)
b2.grid(row=5,column=3)

b3=Button(window,text="AddEntry",width=15,command=add_command)
